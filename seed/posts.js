...
const main = async () => {
    const posts = [
        { name: 'Aloe Vera', description: 'Aloe vera is a succulent post species of the genus Aloe. An evergreen perennial, it originates from the Arabian Peninsula, but grows wild in tropical, semi-tropical, and arid climates around the world. It is cultivated for agricultural and medicinal uses.', image: 'https://upload.wikimedia.org/wikipedia/commons/4/4b/Aloe_vera_flower_inset.png' },
        { name: 'Snake post', description: 'Sansevieria trifasciata is a species of flowering post in the family Asparagaceae, native to tropical West Africa from Nigeria east to the Congo. It is most commonly known as the snake post, Saint Georges sword, mother-in-laws tongue, and vipers bowstring hemp, among other names.', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Snake_post_%28Sansevieria_trifasciata_%27Laurentii%27%29.jpg/2560px-Snake_post_%28Sansevieria_trifasciata_%27Laurentii%27%29.jpg' },
        ...
        { name: 'Spider post', description: 'Chlorophytum comosum, often called spider post but also known as airplane post, St. Bernards lily, spider ivy, ribbon post, and hen and chickens is a species of perennial flowering post. It is native to tropical and southern Africa, but has become naturalized in other parts of the world, including western Australia.', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Hierbabuena_0611_Revised.jpg/1920px-Hierbabuena_0611_Revised.jpg' },
